...
void main() {
  test('initial-deal flower choice resumes dealing and preserves all 144 tiles',
    ...
    final r = Round(ruleset: Ruleset.hongKong, 
        seed: 0,
        dealer: 2,
        roundWind: Wind.east,
        startingPoints: List.filled(4, 1000),
        wall: HongKongWall.fromTiles([
          ...ordinary.take(26),
          ...bonuses,
  ...
  test('round scoring recognizes first-turn Heaven, Earth and Man', () {
    Round fresh() => Round(ruleset: Ruleset.hongKong, 
        seed: 4,
        dealer: 0,
        roundWind: Wind.east,
        startingPoints: List.filled(4, 1000));
