...
Chosen with the ruleset toggle (welcome screen, game app bar, or builder chip
...
| Seven Pairs | 4 | Variant rule, enabled; seven distinct pairs, combinable with flushes / All Honours |
