...
enum TileType {
  ...
  /// tile (its suit is already obvious from the face), the seat number 1-4 for
  /// a flower or season, and a letter for the honours — E/S/W/N for the winds,
  /// B/G/R for white / green / red dragon.
  String get redIndex => isSuit
      ? '$number'
      : isBonus
          ? '$bonusNumber'
          : code;
